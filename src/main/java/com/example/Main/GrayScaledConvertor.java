...
public class GrayScaledConvertor {
    ...
    private static BufferedImage grayScaledConvert (BufferedImage image) {
...
//                use rgb
    ...
    public static void main(String[] args) throws IOException {
        ...
        if(fileChooser.getSelectedFile() != null) {
            ...
            ImageIO.write(grayScaledConvert(image), "png", new File("imggray/gray-"+ selectedFile.getName() + ".png"));
        }
        System.exit(0);
    }
}
